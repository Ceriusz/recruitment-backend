            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('books.update', $book->id) }}" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="name" class="col-md-4 col-form-label text-md-end text-start">Author</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ $book->quantity }}">
                        ...
                        <div class="mb-3 row">
                            <label for="price" class="col-md-4 col-form-label text-md-end text-start">Year</label>
                            <div class="col-md-6">
                                <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ $book->year }}">
                                @if ($errors->has('year'))
                        ...
                        <div class="mb-3 row">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Update Book">
                        </div>
